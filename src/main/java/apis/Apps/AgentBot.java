...
public class AgentBot {
    ...
    @Step("API Create agentApp")
    public AgentBot NewApp(String name, String mode) {
    ...
    @Step("Get Agent App")
    public AgentBot GetNewApp(String _id) {
    ...
    @Step("DeleteApp")
    public AgentBot DeleteApp(String _id){
